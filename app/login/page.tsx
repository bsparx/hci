...
export default function LoginPage() {
    ...
    const handleGoogleLogin = () => {
        ...
        alert('Google Sign-In will be available soon! For now, please use email/password.');
    };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#FF6B00] via-[#FF7A1F] to-[#FF8C3A] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-white/20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="text-right">
                            <button
                                type="button"
                                className="text-sm font-semibold text-[#FF6B00] hover:text-[#FF8C3A] transition-colors"
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full py-4 bg-gradient-to-r from-[#FF6B00] to-[#FF8C3A] text-white font-bold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
                        >
                            {isLoading ? (
                                <>
                ...
                <div className="mt-6 p-4 bg-white/20 backdrop-blur-md border border-white/30 rounded-2xl">
                    <p className="text-sm text-white text-center">
                        <span className="font-semibold">Demo:</span> Create an account or use test@example.com / password123
                    </p>
                </div>
            </div>
        </div>
